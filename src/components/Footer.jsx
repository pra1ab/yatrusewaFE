        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Your reliable bus ticketing and tracking solution. Travel with comfort and convenience.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Transport Avenue, New York, NY 10001</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-400 mr-2 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">support@bustracker.com</span>
              </li>
            </ul>
          </div>
        </div>
