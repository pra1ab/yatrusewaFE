      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-indigo-700 py-20 md:py-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">Have questions about our services? We're here to help. Contact us through any of the channels below.</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-4 px-8 rounded-xl font-medium hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
                  Send Message
                </button>
              </form>
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 hover:bg-blue-200 transition-colors duration-300"
                  >
